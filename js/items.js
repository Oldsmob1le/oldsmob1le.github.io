...
$(document).ready(function () {
  ...
  $('#item-instagram').dblclick(function () {
    window.open('https://www.instagram.com/ko3nigsegg/');
  });


  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/channel/UCVWPQabIztPbesMqQoKs7Dw');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.gg/EYxmYB39fz');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('https://vk.com/ko3nigsegg');
  });
